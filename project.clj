(defproject materialui-design "0.1.0-SNAPSHOT"
  ...
  :main ^:skip-aot materialui-design.core
  ...
  {:nrepl {:port 7002}
   ...
   {:app
    {:target :browser
     ...
     :asset-path "/js"
     :modules {:app {:entries [materialui-design.app]}}
     :devtools
  ...
  {:uberjar {:omit-source true
             ...
             :aot :all
             :uberjar-name "materialui-design.jar"
